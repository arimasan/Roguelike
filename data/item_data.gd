...
const ALL: Array = [
	...
	{"id":"cursed_sword",  "name":"呪われた剣",     "type":TYPE_WEAPON, "atk":28, "cursed":true, "weight":5,  "se":"curse"},
	{"id":"flame_sword",   "name":"炎の剣",         "type":TYPE_WEAPON, "atk":15, "effect":"burn","weight":8,  "se":"fire"},
	# ── 盾 ──────────────────────────────────────────────────
	...
	{"id":"cursed_shield", "name":"呪われた盾",     "type":TYPE_SHIELD, "def":25, "cursed":true, "weight":4,  "se":"curse"},
	# ── 食料 ────────────────────────────────────────────────
